...
>
> ```bash
> git tag -a fase-vu3-migrar-dashboard-vdatatable -m "VU3 cerrada: <el checklist, en una línea por ítem>"
> ```
>
> Los commits de la fase llevan su prefijo (`vu3: …`) y los de ejercicio su
> número (`vu3 ej17: …`). Si un ejercicio merece su propio marcador va en
> `ej/vu3/17`, y un incidente resuelto en el par `inc/vu3/<slug>-roto` /
