...
> [`forense-fase-06.md`](forense-fase-06.md).
...
>
> ```bash
> git tag -a fase-06-wizard-minimo -m "F6 cerrada: <el checklist, en una línea por ítem>"
> ```
>
...
> `ej/f06/17`, y un incidente resuelto en el par `inc/f06/<slug>-roto` /
...
|---|---|---|---|
| 06 | "Volví atrás en el asistente y perdí la descripción" | Formularios y wizard | 🟡 |
