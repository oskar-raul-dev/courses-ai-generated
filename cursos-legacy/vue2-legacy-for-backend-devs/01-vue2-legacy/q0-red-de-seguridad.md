...
- [ ] Tag en git: `git tag pre-quasar` — el punto al que volver cuando te
      pierdas. Y te vas a perder. (Convive con el `fase-q0-red-de-seguridad`
      del cierre: mismo commit, dos nombres. Uno dice "terminé la fase"; el
      otro, "acá es donde vuelvo".)
...
>
> ```bash
> git tag -a fase-q0-red-de-seguridad -m "Q0 cerrada: <el checklist, en una línea por ítem>"
> ```
>
> Los commits de la fase llevan su prefijo (`q0: …`) y los de ejercicio su
> número (`q0 ej17: …`). Si un ejercicio merece su propio marcador va en
> `ej/q0/17`, y un incidente resuelto en el par `inc/q0/<slug>-roto` /
