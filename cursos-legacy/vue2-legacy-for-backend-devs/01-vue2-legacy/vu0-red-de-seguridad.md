...
- [ ] Tag en git: `git tag pre-vuetify` (convive con el
      `fase-vu0-red-de-seguridad` del cierre: mismo commit, dos nombres) — el
      punto al que volver cuando te pierdas. Y te vas a perder.
...
>
> ```bash
> git tag -a fase-vu0-red-de-seguridad -m "VU0 cerrada: <el checklist, en una línea por ítem>"
> ```
>
> Los commits de la fase llevan su prefijo (`vu0: …`) y los de ejercicio su
> número (`vu0 ej17: …`). Si un ejercicio merece su propio marcador va en
> `ej/vu0/17`, y un incidente resuelto en el par `inc/vu0/<slug>-roto` /
