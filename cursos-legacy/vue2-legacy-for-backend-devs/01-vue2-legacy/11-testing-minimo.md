...
> [`forense-fase-11.md`](forense-fase-11.md).
...
>
> ```bash
> git tag -a fase-11-testing-minimo -m "F11 cerrada: <el checklist, en una línea por ítem>"
> ```
>
...
|---|---|---|---|
| 11 | "El test pasa solo cuando lo corro aislado" | Testing | 🔴 |
