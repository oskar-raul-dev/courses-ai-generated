...
>
> ```bash
> git tag -a fase-q4-timeline-actividad -m "Q4 cerrada: <el checklist, en una línea por ítem>"
> ```
>
> Los commits de la fase llevan su prefijo (`q4: …`) y los de ejercicio su
> número (`q4 ej17: …`). Si un ejercicio merece su propio marcador va en
> `ej/q4/17`, y un incidente resuelto en el par `inc/q4/<slug>-roto` /
