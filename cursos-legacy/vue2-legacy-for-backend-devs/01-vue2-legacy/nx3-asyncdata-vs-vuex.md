...
>
> ```bash
> git tag -a fase-nx3-asyncdata-vs-vuex -m "NX3 cerrada: <el checklist, en una línea por ítem>"
> ```
>
> Los commits de la fase llevan su prefijo (`nx3: …`) y los de ejercicio su
> número (`nx3 ej17: …`). Si un ejercicio merece su propio marcador va en
> `ej/nx3/17`, y un incidente resuelto en el par `inc/nx3/<slug>-roto` /
