...
## 🐛 6. Errores clásicos y pieza forense
...
>
> ```bash
> git tag -a fase-q3-migrar-dashboard-qtable -m "Q3 cerrada: <el checklist, en una línea por ítem>"
> ```
>
> Los commits de la fase llevan su prefijo (`q3: …`) y los de ejercicio su
> número (`q3 ej17: …`). Si un ejercicio merece su propio marcador va en
> `ej/q3/17`, y un incidente resuelto en el par `inc/q3/<slug>-roto` /
