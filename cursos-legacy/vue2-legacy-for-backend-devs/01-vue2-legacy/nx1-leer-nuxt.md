...
20. Toma tu tabla de equivalencias y **audita** un repo Nuxt real contra ella: por
...
>
> ```bash
> git tag -a fase-nx1-leer-nuxt -m "NX1 cerrada: <el checklist, en una línea por ítem>"
> ```
>
> Los commits de la fase llevan su prefijo (`nx1: …`) y los de ejercicio su
> número (`nx1 ej17: …`). Si un ejercicio merece su propio marcador va en
> `ej/nx1/17`, y un incidente resuelto en el par `inc/nx1/<slug>-roto` /
