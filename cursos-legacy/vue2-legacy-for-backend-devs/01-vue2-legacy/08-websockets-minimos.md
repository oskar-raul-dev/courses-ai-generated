...
> 💸 **Deuda declarada: el cliente mentiroso.** El anuncio lo debería emitir
> quien persiste, no quien pidió persistir. Aquí se acepta porque el "backend"
> es un relé de veinte líneas. **Se paga en el
> [Curso 02](../02-complement-mongodb-backend/README.md), Fase 12**, donde el
> servidor emite `ticket:created` al confirmar la escritura en Mongo y el
> cliente pasa a ser solo oyente.
...
> [`forense-fase-08.md`](forense-fase-08.md).
...
>
> ```bash
> git tag -a fase-08-websockets-minimos -m "F8 cerrada: <el checklist, en una línea por ítem>"
> ```
>
...
> `ej/f08/17`, y un incidente resuelto en el par `inc/f08/<slug>-roto` /
...
|---|---|---|---|
| 08 | "Se me duplican los tickets cuando entra uno nuevo" | Tiempo real | 🟠 |
