...
>
> ```bash
> git tag -a fase-vu4-timeline-vuetify -m "VU4 cerrada: <el checklist, en una línea por ítem>"
> ```
>
> Los commits de la fase llevan su prefijo (`vu4: …`) y los de ejercicio su
> número (`vu4 ej17: …`). Si un ejercicio merece su propio marcador va en
> `ej/vu4/17`, y un incidente resuelto en el par `inc/vu4/<slug>-roto` /
