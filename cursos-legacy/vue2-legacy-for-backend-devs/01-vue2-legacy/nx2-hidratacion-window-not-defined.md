...
>
> ```bash
> git tag -a fase-nx2-hidratacion-window-not-defined -m "NX2 cerrada: <el checklist, en una línea por ítem>"
> ```
>
> Los commits de la fase llevan su prefijo (`nx2: …`) y los de ejercicio su
> número (`nx2 ej17: …`). Si un ejercicio merece su propio marcador va en
> `ej/nx2/17`, y un incidente resuelto en el par `inc/nx2/<slug>-roto` /
