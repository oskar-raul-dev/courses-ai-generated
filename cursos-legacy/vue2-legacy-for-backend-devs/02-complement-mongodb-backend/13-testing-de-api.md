...
(la checklist de `00-audit-contrato.md`, aprobada en la Fase 10 —su origen es el
...
// Cada fila de la checklist de 00-audit-contrato.md, en código:
...
26. Suite de contrato completa: implementa `test/contract/` con TODAS las filas de la checklist de `00-audit-contrato.md`. Etiquétala y créale su script (`test:contract`). Cuenta: ¿cuántas filas eran automatizables al 100%? ¿Cuáles siguen necesitando el frontend real?
...
>
> ```bash
> git tag -a fase-13-testing-de-api -m "F13 cerrada: <el checklist, en una línea por ítem>"
> ```
>
...
> `ej/f13/17`, y un incidente resuelto en el par `inc/f13/<slug>-roto` /
