...
> [`forense-fase-07.md`](forense-fase-07.md).
...
>
> ```bash
> git tag -a fase-07-indices -m "F7 cerrada: <el checklist, en una línea por ítem>"
> ```
>
...
> `ej/f07/17`, y un incidente resuelto en el par `inc/f07/<slug>-roto` /
...
|---|---|---|---|
| 07 | "Creamos el índice y sigue igual de lento" | Índices | 🟠 |
