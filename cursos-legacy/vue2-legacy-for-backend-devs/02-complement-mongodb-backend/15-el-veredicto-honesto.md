...
>
> ```bash
> git tag -a fase-15-el-veredicto-honesto -m "F15 cerrada: <el checklist, en una línea por ítem>"
> ```
>
> Los commits de la fase llevan su prefijo (`f15: …`) y los de ejercicio su
> número (`f15 ej17: …`). Si un ejercicio merece su propio marcador va en
> `ej/f15/17`, y un incidente resuelto en el par `inc/f15/<slug>-roto` /
