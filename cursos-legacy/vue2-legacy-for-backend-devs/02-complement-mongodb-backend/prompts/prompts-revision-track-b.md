...
Track B, los de Track A, `../00-audit-contrato.md`, `../../prompts/guia-de-estilo-y-convenciones.md`
...
define en ../01-vue2-legacy/03-mock-api-minima.md, ../01-vue2-legacy/05-crud-tickets.md,
../01-vue2-legacy/08-websockets-minimos.md y ../01-vue2-legacy/09-panel-soporte.md.
...
- Deja ESCRITA la lógica del futuro GET /stats (deuda 💸: hoy las métricas se
  calculan en el navegador — nace en Curso 01 · F7 (métricas)).
...
- a01-docker: compose, bind mount vs volumen, el bug del rs.initiate con hostname.
- a02-mongosh-compass: shell como REPL, .mongoshrc.js, Compass (Schema/Explain/
  Pipeline Builder).
- a03-express: pipeline de middlewares, promesas no atrapadas en Express 4 y el
  asyncHandler, el error handler de 4 argumentos.
- a04-seguridad: inyección NoSQL a fondo, BOLA/BOPLA, JWT, rate limiting, uploads
  hostiles, cierre de SECURITY-NOTES.md.
- a05-mongo-vs-sql: historia del hype 2009–2021, CAP/PACELC, Jepsen, el canon del
