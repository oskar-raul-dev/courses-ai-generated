...
>
> ```bash
> git tag -a fase-06-atomicidad-transacciones-consistencia -m "F6 cerrada: <el checklist, en una línea por ítem>"
> ```
>
...
|---|---|---|---|
| 06 | "Dos agentes tomaron el mismo ticket" | Atomicidad | 🟠 |
