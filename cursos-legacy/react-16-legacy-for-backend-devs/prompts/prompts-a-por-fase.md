...
Cada prompt está listo para copiar y pegar en un chat nuevo. Los datos ya están completados según 00-alcance-del-proyecto.md. Solo cópialo tal cual al abrir el chat de esa fase.
...
00-alcance-del-proyecto.md, (3) prompts/guia-de-estilo-y-convenciones.md, (4)
prompts/diccionario-codigo-ingles.md, (5) prompts/plantilla-de-fase.md, (6)
entregables aprobados de fases anteriores, (7) decisiones de este chat.

Contexto de esta fase (ver 00-alcance-del-proyecto.md §5 y §7):
- Fase: 0 de 11.
...
Estilo del código de esta fase (prompts/guia-de-estilo-y-convenciones.md §5):
