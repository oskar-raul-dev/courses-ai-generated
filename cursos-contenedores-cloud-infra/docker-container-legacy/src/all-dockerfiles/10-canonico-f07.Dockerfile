# Copia consolidada del Dockerfile canónico tal como NACE en la Fase 07,
# en la raíz del laboratorio. Es idéntico al pedagógico 05-node/06-build:
# F07 lo promueve sin cambiarle una línea. F08 le añade entrypoint y shims.
